    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-6">
          <h1 className="text-lg font-semibold text-white mb-1">新規登録</h1>
          <p className="text-sm text-zinc-400 mb-6">アカウントを作成してください</p>

          {error && (
            <div className="bg-rose-500/10 border border-rose-500/30 rounded-lg px-4 py-2.5 mb-4">
              <p className="text-sm text-rose-400">登録に失敗しました。別のメールアドレスをお試しください</p>
            </div>
          )}
